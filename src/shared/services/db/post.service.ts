import { updatedPost } from './../../../mocks/post.mocks';
...
class PostService {
  ...
  public async postsCount(): Promise<number> {
    // countDocuments to find the number of documents you have in a collection
    // This will return the number of documents we have in the PostModel collection
