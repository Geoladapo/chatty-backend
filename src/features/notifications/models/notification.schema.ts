...
import { INotification, INotificationDocument } from '../interfaces/notifcation.interface';
...
// This method is used to add or Create a notitication that will be saved to the notification collection
