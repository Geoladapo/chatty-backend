import * as cloudinaryUploads from '@/root/shared/globals/helpers/cloudinary-upload';
import { Response, Request } from 'express';
import { SignUp } from '../signup';
import { authMock, authMockRequest, authMockResponse } from '@/root/mocks/auth.mocks';
import { CustomError } from '@/root/shared/globals/helpers/error-handler';
...
describe('SignUp', () => {
  ...
  it('should throw an error if username is not available', () => {
    const req: Request = authMockRequest(
      {}, //for signup, we don't need session so we make this an empty object
      {
        username: '',
        email: 'nammy@test.com',
        password: 'qwerty',
        avatarColor: 'red',
